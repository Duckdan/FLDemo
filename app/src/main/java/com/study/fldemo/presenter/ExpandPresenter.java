 ...
 */
public class ExpandPresenter implements ExpandContract.Presenter {
    private final Context context;
    private final ExpandContract.View view;
    private final HttpConnectUtils utils;
    private final Random random;

    public ExpandPresenter(Context context, ExpandContract.View view) {
