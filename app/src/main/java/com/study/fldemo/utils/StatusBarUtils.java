...
public final class StatusBarUtils {
    ...
    private static final java.lang.String TAG = StatusBarUtils.class.getSimpleName();
    ...
    private void processActionBar(final View v) {
        ...
        v.post(new Runnable() {
            ...
            public void run() {
                ...
                int top = paddingTop == 0 ? paddingTop + getStatusBarOffsetPx(v.getContext()) : paddingTop;
                v.setPadding(v.getPaddingLeft(), top, v.getPaddingRight(), v.getPaddingBottom());
                ViewGroup.LayoutParams layoutParams = v.getLayoutParams();
                if (!actionBarOtherColor) {
                    v.setBackgroundColor(ResourceUtils.getColor(android.R.color.white));
                }
                float dimension = v.getContext().getResources().getDimension(R.dimen.title_bar_height);
