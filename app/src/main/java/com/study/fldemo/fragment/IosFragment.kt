...
class IosFragment : BaseFragment(), IosContract.View, SwipeRefreshLayout.OnRefreshListener {
...
//    internal var srl: SwipeRefreshLayout? = null
    private lateinit var presenter: IosPresenterKt
