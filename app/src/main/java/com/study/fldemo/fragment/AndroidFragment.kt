...
class AndroidFragment : BaseFragment(), AndroidContract.View, SwipeRefreshLayout.OnRefreshListener {
    ...
    //    @BindView(R.id.ll_bg)
//    internal var llBg: LinearLayout? = null
//    @BindView(R.id.tv_net)
//    internal var tvNet: TextView? = null
//    @BindView(R.id.rv)
//    internal var rv: RecyclerView? = null
//    @BindView(R.id.tv_loading)
//    internal var tvLoading: TextView? = null
//    @BindView(R.id.srl)
//    internal var srl: SwipeRefreshLayout? = null
    private var presenter: AndroidPresenterKt? = null
    ...
    override fun setUserVisibleHint(isVisibleToUser: Boolean) {
        ...
        if (presenter == null) {
            presenter = AndroidPresenterKt(this)
        }
        if (isVisibleToUser) {
            queryOriginalData()
        }
                ...
                if (newState == RecyclerView.SCROLL_STATE_IDLE) {
                    ...
                    lastPosition = when (layoutManager) {
                        ...
                        is GridLayoutManager -> {
                            ...
                            glm!!.findLastCompletelyVisibleItemPosition()
                        }
                        else -> {
                            ...
                            findMaxPosition(positions)
                        }
                    }

                    if (lastPosition == recyclerView.adapter?.itemCount ?: 0 - 1) {
